...
s=s.replace("const icon=L.divIcon({className:'',html:aybSahaNotIconHtml(),iconSize:[34,34],iconAnchor:[17,17]});\n  const m=L.marker([+n.lat,+n.lng],{icon,zIndexOffset:1100,riseOnHover:true}).addTo(map);", "const icon=L.divIcon({className:'ayb-saha-note-leaflet',html:aybSahaNotIconHtml(),iconSize:[24,24],iconAnchor:[12,12]});\n  const m=L.marker([+n.lat,+n.lng],{icon,zIndexOffset:1100,riseOnHover:true,keyboard:false}).addTo(map);\n  try{m._zoomAnimated=false;}catch(e){}")
